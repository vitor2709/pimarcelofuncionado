function EmptyCart() {
  return (
    <div className="flex flex-col items-center justify-center text-center py-20">
      ...
      <a href="/" className="flex h-11 min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-md bg-primary px-6 text-sm font-bold text-white tracking-wide transition-colors hover:bg-primary/90">
